          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="p-4 rounded-xl bg-[#0b0f2b] border border-[var(--accent-cyan)]/20">
              ...
              <div className="flex items-center gap-3">
                ...
                <code className="text-white font-mono text-sm md:text-base break-all select-all">https://backend-app-9a62n.ondigitalocean.app/api/kb/factcheck/search</code>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-[#0b0f2b] border border-[var(--accent-purple)]/20">
              ...
              <div className="flex items-center gap-3">
                <code className="text-[var(--accent-cyan)] font-bold">POST</code>
                <code className="text-white font-mono text-sm md:text-base break-all select-all">https://backend-app-9a62n.ondigitalocean.app/api/kb/legal/search</code>
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex gap-4 mb-6">
            <button
              ...
              className={`flex-1 p-4 rounded-xl border transition-all ${activeFramework === 'agno'
            ...
            <button
              ...
              className={`flex-1 p-4 rounded-xl border transition-all ${activeFramework === 'crewai'
